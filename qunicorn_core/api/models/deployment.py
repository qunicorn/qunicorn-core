...
class PreDeploymentSchema(MaBaseSchema):
    uid = ma.fields.Integer(required=False, metadata={
        "descrption" : "UID for the deployment"
    })
    name = ma.fields.String(required=True, metadata={
        "description": "An optional Name for the deployment."
    })
    mode = ma.fields.String(required=True, metadata={
        "description": "Describes whether a Job should be pre-deployed or executed ad-hoc."
    })
    description = ma.fields.String(required=False, metadata={
...
class DeploymentResponseSchema(MaBaseSchema):
     uid = ma.fields.Integer(required=False, metadata={
        "descrption" : "Unique Identifier for the deployment"
    })
